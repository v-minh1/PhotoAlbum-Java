...
## **Goal**
Based on the project to provide a plan to deploy the project to Azure appservice in resource group  and subscription  with tool AZCLI.
...
graph TD
%% Services
svcazureappservice_fakeservice0["`Name: fakeservice0
Path: ..\test\project\fakeservice1
Language: js`"]
subgraph "Compute Resources"
%% Resources
azureappservice_fakeservice0("`fakeservice0 (Azure App Service)`")
end
...
%% Relationships
svcazureappservice_fakeservice0 --> |"hosted on"| azureappservice_fakeservice0
azureappservice_fakeservice0 -.-> |"secret"| azurecosmosdb_db0
azureappservice_fakeservice0 -.-> |"user-identity"| azuresqldatabase_db1
```
