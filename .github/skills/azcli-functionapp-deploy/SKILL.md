...
## **Goal**
Based on the project to provide a plan to deploy the project to Azure functionapp in resource group  and subscription  with tool AZCLI.
...
graph TD
%% Services
svcazurefunctions_fakeservice0["`Name: fakeservice0
Path: ..\test\project\fakeservice1
Language: js`"]
subgraph "Compute Resources"
%% Resources
azurefunctions_fakeservice0("`fakeservice0 (Azure Functions)`")
end
...
%% Relationships
svcazurefunctions_fakeservice0 --> |"hosted on"| azurefunctions_fakeservice0
azurefunctions_fakeservice0 -.-> |"secret"| azurecosmosdb_db0
azurefunctions_fakeservice0 -.-> |"user-identity"| azuresqldatabase_db1
```
